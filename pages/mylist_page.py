...
private_label_in_the_left_menu = (By.CSS_SELECTOR, '[tabindex="-1"]>.privacy-text>span')
private_label_in_the_left_near_settings = (By.CSS_SELECTOR, 'p.flex.items-center.text-sm')
...
class MyListPage(BasePage):
    ...
    def is_private_label_displayed(self):
        private_label_in_the_left_menu_element = self.find_element(private_label_in_the_left_menu)
        assert private_label_in_the_left_menu_element.text == private_label_in_the_left_menu_text
        private_label_in_the_left_near_settings_element = self.find_element(private_label_in_the_left_near_settings)
