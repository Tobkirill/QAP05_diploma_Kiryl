...
def test_ability_to_create_public_list_with_gifster_and_google_search_option(driver):
    create_new_list_page = CreateNewListPage(driver)
    create_new_list_page.open_new_list_page()
    create_new_list_page.fill_in_field(name_of_list_field, name_of_list_text)
...
def test_ability_to_create_public_list_with_gifster_search_option(driver):
    create_new_list_page = CreateNewListPage(driver)
    create_new_list_page.open_new_list_page()
    create_new_list_page.fill_in_field(name_of_list_field, name_of_list_text)
    create_new_list_page.choose_privacy_of_list(public_list_button)
...
def test_ability_to_create_public_list_with_share_link_option(driver):
    create_new_list_page = CreateNewListPage(driver)
    create_new_list_page.open_new_list_page()
    create_new_list_page.fill_in_field(name_of_list_field, name_of_list_text)
    create_new_list_page.choose_privacy_of_list(public_list_button)
